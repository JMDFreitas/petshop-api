...
async function createProprietario(req, res, next) {
    try {
        ...
        proprietario = await ProprietarioService.createProprietario(
            proprietario
        );
...
async function updateProprietario(req, res, next) {
    try {
        ...
        proprietario = await ProprietarioService.updateProprietario(
            proprietario
        );
        res.send(proprietario);
...
async function getProprietarios(_req, res, next) {
    try {
